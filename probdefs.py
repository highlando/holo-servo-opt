        ...
        def trajec(t):
            if t < tM - trnsarea/2.:
                ...
                if polydeg == 1:
                    ...
                    dog = g0 + (7*1716*s**6 - 8*9009*s**7 + 9*20020*s**8
                                - 10*24024*s**9 + 11*16380*s**10
                                - 12*6006*s**11 + 13*924*s**12)*dsdt*(gf - g0)
                    ddg = (6*7*1716*s**5 - 7*8*9009*s**6
                           + 8*9*20020*s**7 - 9*10*24024*s**8
                           + 10*11*16380*s**9 - 11*12*6006*s**10
                           + 12*13*924*s**11)*dsdt**2*(gf - g0)
                    dtg = (5*6*7*1716*s**4 - 6*7*8*9009*s**5
                           + 7*8*9*20020*s**6 - 8*9*10*24024*s**7
                           + 9*10*11*16380*s**8 - 10*11*12*6006*s**9
                           + 11*12*13*924*s**10)*dsdt**3*(gf - g0)
